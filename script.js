...
async function getAiReading() {
  ...
  const prompt = `คุณคือแม่หมอไพ่ยิปซีผู้เชี่ยวชาญการทำนายและให้แนวทางชีวิต กรุณาทำนายโชคชะตาด้วยความสุขุม ลึกลับ และน่าดึงดูด
...
โปรดเรียบเรียงคำทำนายและคำอธิบายโดยละเอียดเป็นภาษาไทย โดยให้มีความเชื่องโยงกันและเหมาะสมกับคำถาม และมีข้อแนะนำหรือสิ่งที่ต้องพึงระลึกไว้เตือนใจท้ายคำทำนายด้วย`;
